...
class PhonesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create phone" do
    assert_difference('Phone.count') do
      post phones_url, params: { phone: { category: @phone.category, description: @phone.description, image_url: @phone.image_url, price: @phone.price, title: @phone.title } }
    end
  ...
  test "should update phone" do
    patch phone_url(@phone), params: { phone: { category: @phone.category, description: @phone.description, image_url: @phone.image_url, price: @phone.price, title: @phone.title } }
